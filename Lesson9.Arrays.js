...
console.log(getFirstAndLast(["Red"]));
...
console.log(getSecondElement([3, 6]));
...
let getFirstGreaterThanTen = (arr) => {
...
console.log (getFirstGreaterThanTen([5, 20, 30]));