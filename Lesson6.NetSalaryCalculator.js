...
function netSalaryCalculator(grossSalary) {
    if (typeof grossSalary !== "number" || grossSalary <= 0) {
         return ("The provided salary is invalid. Please provide an actual salary.");
    } 
...
console.log(netSalaryCalculator(500000));
console.log(netSalaryCalculator(1125000));
console.log(netSalaryCalculator("m"));